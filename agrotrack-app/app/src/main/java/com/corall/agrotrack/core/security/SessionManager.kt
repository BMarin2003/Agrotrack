...
class SessionManager @Inject constructor(
    ...
    fun getRole(): UserRole {
        val savedRole = prefs.getString(KEY_ROLE, UserRole.OPERATOR.name)
        return runCatching { UserRole.valueOf(savedRole ?: UserRole.OPERATOR.name) }
