...
class AuthRepositoryImpl @Inject constructor(
    ...
    private fun mapRole(roleNames: List<String>): UserRole {
        return when {
            roleNames.any { it.equals("Administrador", ignoreCase = true) } -> UserRole.ADMIN
            roleNames.any { it.equals("Técnico", ignoreCase = true) || it.equals("Tecnico", ignoreCase = true) } -> UserRole.TECHNICIAN
